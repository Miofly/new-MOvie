<script>
    ...
    export default {
        ...
        methods: {
            ...
            initData () {
                this.ui.yunFun('getDataPage', {
                    ...
                    this.$store.state.ggkzs = data.ggkzs
                    this.$store.state.bdyCode = data.bdyCode
                    this.$store.state.bdyContent = data.bdyContent
                    ...
                    console.log(this.$store.state.defaultPage)
                })
            },
            share: function () { // 全局分享
                wx.onAppRoute(res => {
        ...
        computed: {
            ...mapState(['ggkzs', 'bdyCode', 'bdyContent', 'masters', 'indexArr', 'defaultPage']),
        },
    }
</script>
